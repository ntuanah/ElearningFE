...
const CreateCourse = () => {
  ...
  const handleSaveCourse = async () => {
    ...
    if (!formData.level) {
      return toast.error("Vui lòng chọn cấp độ khoá học!");
    }
    ...
    if (!formData.objectives.trim()) {
      return toast.error("Vui lòng nhập mục tiêu khoá học!");
    }
    ...
    try {
      ...
      await courseService.publishCourse(newCourseId);
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div className="font-bold text-2xl text-red-500">Tạo khoá học</div>
        <button
        ...
        >
          {isLoading ? "Đang tạo..." : "Tạo khoá học"}
        </button>
      </div>
