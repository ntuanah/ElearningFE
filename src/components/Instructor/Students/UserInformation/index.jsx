const UserInformation = ({onClose}) => { 
    return (
        <div className="fixed inset-0 bg-red/40 backdrop-blur-sm overflow-y-auto flex justify-center py-10 z-50"
      onClick={onClose}>
            <div className="bg-white rounded-lg w-6/7 p-6 border border-red-200 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="border border-red-200 p-4 mb-4 rounded-2xl flex gap-6 items-center">
                    <div className="w-32 h-32 rounded-full overflow-hidden mb-4 border border-red-200">
                        <img src="https://static.vecteezy.com/system/resources/previews/024/766/958/non_2x/default-male-avatar-profile-icon-social-media-user-free-vector.jpg" alt="" />
                    </div>

                    <div>
                        <div className="flex items-center">    
                            <div className="font-semibold text-2xl text-red-500 "> Nguyen Tuan Anh</div>
                            <div className="bg-green-200 py-2 px-4 rounded-xl text-green-700 font-semibold w-fit ml-4">active</div>
                        </div>

                        <div className="mt-2 text-gray-500 max-w-[1200px] break-words">
                            Day la tieu su sdvkvblsdfvbhfdkvbhflbhdshvlfhbvlifdhbjnfgbjfdnkjfdbvkldfjbkfbhdfjkbfjbdfj,bvdflbfdlvjbdlvdskjvbdfkbvkdfsbvkbsdfjbvjfbsjvbjsfbhjbfjhbvkjsfdkvjnfkjvkfjsnvkjsfnkjvnsfjkvkjsfvkjsfkjvfskjvkjsfvkjfsnjkvns
                        </div>

                        <div className="flex gap-6">
                            <div className="flex items-center gap-2 mt-4">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="red" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="m7 9l5 3.5L17 9"/><path d="M2 17V7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2Z"/></g></svg>
                                </div>
                                <div>
                                    ntuanah@gmail.com
                                </div>
                            ...
                            <div className="flex items-center gap-2 mt-4">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="red" d="M19.5 22a1.5 1.5 0 0 0 1.5-1.5V17a1.5 1.5 0 0 0-1.5-1.5c-1.17 0-2.32-.18-3.42-.55a1.51 1.51 0 0 0-1.52.37l-1.44 1.44a14.77 14.77 0 0 1-5.89-5.89l1.43-1.43c.41-.39.56-.97.38-1.53c-.36-1.09-.54-2.24-.54-3.41A1.5 1.5 0 0 0 7 3H3.5A1.5 1.5 0 0 0 2 4.5C2 14.15 9.85 22 19.5 22M3.5 4H7a.5.5 0 0 1 .5.5c0 1.28.2 2.53.59 3.72c.05.14.04.34-.12.5L6 10.68c1.65 3.23 4.07 5.65 7.31 7.32l1.95-1.97c.14-.14.33-.18.51-.13c1.2.4 2.45.6 3.73.6a.5.5 0 0 1 .5.5v3.5a.5.5 0 0 1-.5.5C10.4 21 3 13.6 3 4.5a.5.5 0 0 1 .5-.5"/></svg>
                                </div>
                                <div>
                                    0987244992
                                </div>
                            ...
                            <div className="flex items-center gap-2 mt-4">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="red" d="M19.5 4h-3V2.5a.5.5 0 0 0-1 0V4h-7V2.5a.5.5 0 0 0-1 0V4h-3A2.503 2.503 0 0 0 2 6.5v13A2.503 2.503 0 0 0 4.5 22h15a2.5 2.5 0 0 0 2.5-2.5v-13A2.5 2.5 0 0 0 19.5 4M21 19.5a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 19.5V11h18zm0-9.5H3V6.5C3 5.672 3.67 5 4.5 5h3v1.5a.5.5 0 0 0 1 0V5h7v1.5a.5.5 0 0 0 1 0V5h3A1.5 1.5 0 0 1 21 6.5z"/></svg>
                                </div>
                                <div>
                                    01-12-2025
                                </div>
        ...
        <div className="grid grid-cols-12 gap-4">
            <div className="col-span-8">
                <div className="border border-red-200 p-4 flex rounded-2xl h-100">
                    <div className="font-bold text-2xl text-red-500">Cac khoa hoc da dang ky</div>
                </div>
            </div>
            <div className="col-span-4 flex flex-col gap-4">
                ...
                <div className="bg-white p-6 shadow rounded-2xl border border-red-200">
                    <div className="text-2xl font-bold text-red-500 mb-6">Thông tin tài khoản</div>
                ...
                <div className="border border-red-200 p-4 rounded-2xl">
                    <div className="text-2xl text-red-500 font-bold">Thao tác nhanh</div>
                    <button className="border border-red-200 rounded-2xl py-2 w-full mt-4 font-semibold text-red-500 hover:bg-red-200">Reset Password</button>
                </div>
